 ...
 *       AN4,AN4,AN2,AN1,AN0 are Analog functionality.
 */
...
/**
 * @brief Start the Analog_To_Digital Conversion
 */
 ...
 * @note    ADC_CONVERSON_ENABLE()      : Enable the Analog-To-Digital
 *          ADC_CONVERSON_DISABLE()     : Disable the Analog-To-Digital
 */
#define ADC_CONVERSION_ENABLE()         (ADCON0bits.ADON = 1)
#define ADC_CONVERSION_DISABLE()        (ADCON0bits.ADON = 0)

/**
 * @brief   Voltage_Reference Configuration 
...
#define ADC_RESULT_LEGT_FORMAT()    (ADCON2bits.ADFM = 0)
 ...
 * @note    Acquisition time of a Successive Approximation Register (SAR) ADC is the amount of the time 
