...
#define ADC_HighPriorityySet()                      (IPR1bits.ADIP = 1)
/*  This routine set the ADC Module  Interrupt Priority to be Low priority   */
#define ADC_LowPriorityySet()                        (IPR1bits.ADIP = 0)
#endif
#endif
...
#define TIMER0_HighPriorityySet()                      (INTCON2bits.TMR0IP = 1)
/*  This routine set the TIMER0 Module  Interrupt Priority to be Low priority   */
#define TIMER0_LowPriorityySet()                       (INTCON2bits.TMR0IP = 0)
#endif
#endif
...
#define TIMER1_HighPriorityySet()                      (IPR1bits.TMR1IP = 1)
/*  This routine set the TIMER1 Module  Interrupt Priority to be Low priority   */
#define TIMER1_LowPriorityySet()                       (IPR1bits.TMR1IP = 0)
#endif
#endif
...
#define TIMER2_HighPriorityySet()                      (IPR1bits.TMR2IP = 1)
/*  This routine set the TIMER2 Module  Interrupt Priority to be Low priority   */
#define TIMER2_LowPriorityySet()                       (IPR1bits.TMR2IP = 0)
#endif
#endif
...
#define TIMER3_HighPriorityySet()                      (IPR2bits.TMR3IP = 1)
/*  This routine set the TIMER3 Module  Interrupt Priority to be Low priority   */
#define TIMER3_LowPriorityySet()                       (IPR2bits.TMR3IP = 0)
#endif
#endif
...
#define CCP1_HighPriorityySet()                      (IPR1bits.CCP1IP = 1)
/*  This routine set the CCP1 Module  Interrupt Priority to be Low priority   */
#define CCP1_LowPriorityySet()                       (IPR1bits.CCP1IP = 0)
#endif
#endif
...
#define CCP2_HighPriorityySet()                      (IPR2bits.CCP2IP = 1)
/*  This routine set the CCP2 Module  Interrupt Priority to be Low priority   */
#define CCP2_LowPriorityySet()                       (IPR2bits.CCP2IP = 0)
#endif
#endif
...
#define EUSART_TX_HighPriorityySet()                      (IPR1bits.TXIP = 1)
/*  This routine set the EUSART Module  Interrupt Priority to be Low priority   */
#define EUSART_TX_LowPriorityySet()                       (IPR1bits.TXIP = 0)
#endif
#endif
...
#if INTERRUPT_PRIORITY_LEVELS_ENABLE==INTERRUPT_FEATURE_ENABLE
/*  This routine set the EUSART Module  Interrupt Priority to be High priority   */
#define EUSART_RX_HighPriorityySet()                      (IPR1bits.RCIP = 1)
/*  This routine set the EUSART Module  Interrupt Priority to be Low priority   */
#define EUSART_RX_LowPriorityySet()                       (IPR1bits.RCIP = 0)
#endif
#endif
...
#define MSSP_I2C_HighPriorityySet()                      (IPR1bits.SSPIP = 1)
#define MSSP_I2C_BUS_COL_HighPriorityySet()              (IPR2bits.BCLIP = 1)
/*  This routine set the MSSP I2C Module  Interrupt Priority to be Low priority   */
#define MSSP_I2C_LowPriorityySet()                       (IPR1bits.SSPIP = 0)
#define MSSP_I2C_BUS_COL_LowPriorityySet()               (IPR2bits.BCLIP = 0)
#endif
#endif
