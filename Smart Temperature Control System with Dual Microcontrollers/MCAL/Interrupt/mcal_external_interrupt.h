...
/*  This routine sets the edge detect of  the extern interrupt to negative edge */
#define EXT_INT0_RisingEdgeSet()                        (INTCON2bits.INTEDG0 = 1)
/*  This routine clears the edge detect of  the extern interrupt to positive edge */
...
/*  This routine sets the interrupt disable for the external interrupt, INT1 */
...
/*  This routine sets the edge detect of  the extern interrupt to positive edge */
...
#define EXT_RBx_HighPriorityySet()                 (INTCON2bits.RBIP = 1)
/*  This routine set the RBx External Interrupt Priority to be Low priority   */
#define EXT_RBx_LowPriorityySet()                  (INTCON2bits.RBIP = 0)
#endif
