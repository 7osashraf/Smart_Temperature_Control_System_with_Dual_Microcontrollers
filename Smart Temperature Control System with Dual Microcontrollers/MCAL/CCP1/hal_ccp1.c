...
static Std_ReturnType CCP_Compare_Mode_Config(const ccp_t *_ccp_obj){
    ...
    if(CCP1_INST == _ccp_obj->ccp_inst){
        ...
        switch(_ccp_obj->ccp_mode_variant){
            case CCP_COMPARE_MODE_SET_BIN_LOW : CCP1_SET_MODE(CCP_COMPARE_MODE_SET_BIN_LOW); break;
            case CCP_COMPARE_MODE_SET_BIN_HIGH : CCP1_SET_MODE(CCP_COMPARE_MODE_SET_BIN_HIGH); break;
       ...
       /*  CCP2 Module Compare Variants Mode Initialization    */
        switch(_ccp_obj->ccp_mode_variant){
            case CCP_COMPARE_MODE_SET_BIN_LOW : CCP2_SET_MODE(CCP_COMPARE_MODE_SET_BIN_LOW); break;
            case CCP_COMPARE_MODE_SET_BIN_HIGH : CCP2_SET_MODE(CCP_COMPARE_MODE_SET_BIN_HIGH); break;
