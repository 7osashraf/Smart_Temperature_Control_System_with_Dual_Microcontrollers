 ...
 * Author: ENG HOSAM
 *
 * Created on September 6, 2023, 6:24 PM
 */
...
/* Slave Mode Daa/Address Indication */
...
#define I2C_SLAVE_MODE_DEFINED_CLOCK                0X08U
#define I2C_SLAVE_MODE_FIRMWARE_CONTROLLED          0X0BU
