...
# 12 "./ECU/LED/../../MCAL/GPIO/hal_gpio.h"
...
# 12 "./ECU/LED/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "./ECU/LED/../../MCAL/GPIO/../mcal_std_types.h" 1
# 12 "./ECU/LED/../../MCAL/GPIO/../mcal_std_types.h"
...
# 12 "./ECU/LED/../../MCAL/GPIO/../mcal_std_types.h" 2

# 1 "./ECU/LED/../../MCAL/GPIO/../compiler.h" 1
# 11 "./ECU/LED/../../MCAL/GPIO/../compiler.h"
...
# 11 "./ECU/LED/../../MCAL/GPIO/../compiler.h" 2
# 13 "./ECU/LED/../../MCAL/GPIO/../mcal_std_types.h" 2
...
# 1 "./ECU/LED/../../MCAL/GPIO/hal_gpio_cfg.h" 1
# 15 "./ECU/LED/../../MCAL/GPIO/hal_gpio.h" 2
# 37 "./ECU/LED/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
Std_ReturnType gpio_pin_get_direction_statues(const pin_config_t *_pin_config, direction_t *direction_statues);
...
# 1 "./ECU/button/ecu_button_cfg.h" 1
# 13 "./ECU/button/ecu_button.h" 2
# 24 "./ECU/button/ecu_button.h"
typedef enum{
    BUTTON_PRESSED,
    BUTTON_RELEASED
}button_state_t;
...
# 1 "./ECU/Relay/ecu_relay_cfg.h" 1
# 13 "./ECU/Relay/ecu_relay.h" 2
# 23 "./ECU/Relay/ecu_relay.h"
typedef struct{
    uint8 relay_port : 4;
    uint8 relay_pin : 3;
...
# 12 "./ECU/DC_Motor/ecu_dc_motor.h"
# 1 "./ECU/DC_Motor/ecu_dc_motor_cfg.h" 1
# 12 "./ECU/DC_Motor/ecu_dc_motor.h" 2
...
# 1 "./ECU/7_segment/ecu_7_segment_cfg.h" 1
# 12 "./ECU/7_segment/ecu_7_segment_cfg.h"
# 1 "./ECU/7_segment/ecu_7_segment.h" 1
# 12 "./ECU/7_segment/ecu_7_segment_cfg.h" 2
# 12 "./ECU/7_segment/ecu_7_segment.h" 2
# 26 "./ECU/7_segment/ecu_7_segment.h"
typedef enum{
...
# 11 "./ECU/KeyPad/ecu_keypad.h"
# 1 "./ECU/KeyPad/ecu_keypad_cfg.h" 1
# 11 "./ECU/KeyPad/ecu_keypad.h" 2
...
# 1 "./ECU/Chr_LCD/ecu_chr_lcd.h" 1
# 11 "./ECU/Chr_LCD/ecu_chr_lcd.h"
# 1 "./ECU/Chr_LCD/ecu_chr_lcd_cfg.h" 1
# 11 "./ECU/Chr_LCD/ecu_chr_lcd.h" 2
...
Std_ReturnType lcd_4bit_send_custome_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 col,
...
Std_ReturnType lcd_8bit_send_custome_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 col,
                                          const uint8 _chr[], uint8 mem_pos) ;
...
# 15 "./MCAL/Interrupt/mcal_interrupt_config.h"
# 1 "./MCAL/Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "./MCAL/Interrupt/mcal_interrupt_config.h" 2
# 56 "./MCAL/Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY,
}interrupt_priority_cfg;
# 14 "./MCAL/Interrupt/mcal_external_interrupt.h" 2
# 86 "./MCAL/Interrupt/mcal_external_interrupt.h"
...
# 14 "./MCAL/EEPROM/hal_eeprom.h"
# 1 "./MCAL/EEPROM/../../MCAL/Interrupt/mcal_internal_interrupt.h" 1
# 14 "./MCAL/EEPROM/hal_eeprom.h" 2
# 38 "./MCAL/EEPROM/hal_eeprom.h"
Std_ReturnType Data_EEPROM_WriteByte(uint16 bAdd, uint8 bData);
Std_ReturnType Data_EEPROM_ReadByte(uint16 bAdd, uint8 *bData);
# 24 "./app.h" 2

# 1 "./MCAL/ADC/hal_adc.h" 1
# 18 "./MCAL/ADC/hal_adc.h"
# 1 "./MCAL/ADC/hal_adc_cfg.h" 1
# 18 "./MCAL/ADC/hal_adc.h" 2
# 102 "./MCAL/ADC/hal_adc.h"
typedef enum{
    ADC_CHANNEL_AN0 = 0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
# 1 "./MCAL/usart/hal_usart.h" 1
# 16 "./MCAL/usart/hal_usart.h"
# 1 "./MCAL/usart/hal_usart_cfg.h" 1
# 16 "./MCAL/usart/hal_usart.h" 2
# 63 "./MCAL/usart/hal_usart.h"
typedef enum{
...
Std_ReturnType EUSART_ASYNC_ReadStringBlocking(uint8 *_data, uint16 str_len);
Std_ReturnType EUSART_ASYNC_ReadStringNonBlocking(uint8 *_data, uint16 str_len);
...
void usart_module_init(){
    ...
    usart_obj.EUSART_TxDefaultInterruptHandler = ((void*)0);
