...
# 25 "MCAL/Interrupt/mcal_interrupt_manager.h"
void INT0_ISR(void);
void INT1_ISR(void);
void INT2_ISR(void);
void ADC_ISR(void);
...
# 32 "MCAL/Interrupt/mcal_interrupt_manager.c"
void __attribute__((picinterrupt(("")))) InterruptManagerHigh(void){
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB4 == GPIO_HIGH) && (RB4_Flag == 0)){
        RB4_Flag = 0;
        RB4_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB4 == GPIO_LOW) && (RB4_Flag == 1)){
        RB4_Flag = 1;
        RB4_ISR(1);
    }
    else{ }
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB5 == GPIO_HIGH) && (RB5_Flag == 0)){
        RB5_Flag = 0;
        RB5_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB5 == GPIO_LOW) && (RB5_Flag == 1)){
        RB5_Flag = 1;
        RB5_ISR(1);
    }
    else{ }
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB6 == GPIO_HIGH) && (RB6_Flag == 0)){
        RB6_Flag = 0;
        RB6_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB6 == GPIO_LOW) && (RB6_Flag == 1)){
        RB6_Flag = 1;
        RB6_ISR(1);
    }
    else{ }
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB7 == GPIO_HIGH) && (RB7_Flag == 0)){
        RB7_Flag = 0;
        RB7_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB7 == GPIO_LOW) && (RB7_Flag == 1)){
        RB7_Flag = 1;
        RB7_ISR(1);
    }
    else{ }
