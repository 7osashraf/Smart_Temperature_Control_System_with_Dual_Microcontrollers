...
# 12 "MCAL/usart/hal_usart.h" 2

# 1 "MCAL/usart/../mcal_std_types.h" 1
# 12 "MCAL/usart/../mcal_std_types.h"
# 1 "MCAL/usart/../std_libraries.h" 1
# 13 "MCAL/usart/../std_libraries.h"
...
# 13 "MCAL/usart/../std_libraries.h" 2
...
# 14 "MCAL/usart/../std_libraries.h" 2
...
# 15 "MCAL/usart/../std_libraries.h" 2
# 12 "MCAL/usart/../mcal_std_types.h" 2

# 1 "MCAL/usart/../compiler.h" 1
# 11 "MCAL/usart/../compiler.h"
...
# 11 "MCAL/usart/../compiler.h" 2
# 13 "MCAL/usart/../mcal_std_types.h" 2
...
# 13 "MCAL/usart/hal_usart.h" 2

# 1 "MCAL/usart/../../MCAL/GPIO/hal_gpio.h" 1
# 14 "MCAL/usart/../../MCAL/GPIO/hal_gpio.h"
# 1 "MCAL/usart/../../MCAL/GPIO/../device_config.h" 1
# 14 "MCAL/usart/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "MCAL/usart/../../MCAL/GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL/usart/../../MCAL/GPIO/hal_gpio.h" 2
# 37 "MCAL/usart/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 14 "MCAL/usart/hal_usart.h" 2

# 1 "MCAL/usart/../../MCAL/Interrupt/mcal_internal_interrupt.h" 1
# 14 "MCAL/usart/../../MCAL/Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL/usart/../../MCAL/Interrupt/mcal_interrupt_config.h" 1
# 15 "MCAL/usart/../../MCAL/Interrupt/mcal_interrupt_config.h"
# 1 "MCAL/usart/../../MCAL/Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL/usart/../../MCAL/Interrupt/mcal_interrupt_config.h" 2
# 56 "MCAL/usart/../../MCAL/Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY,
}interrupt_priority_cfg;
# 14 "MCAL/usart/../../MCAL/Interrupt/mcal_internal_interrupt.h" 2
# 15 "MCAL/usart/hal_usart.h" 2
...
Std_ReturnType EUSART_ASYNC_ReadStringBlocking(uint8 *_data, uint16 str_len) {
    ...
    while (char_counter < str_len) {
        ...
        _data[char_counter] = RCREG;
        char_counter++;


        if (_data[char_counter - 1] == '\n') {
            break;
        }
    }


    _data[char_counter] = '\0';


    if (char_counter >= str_len) {
        ret = (Std_ReturnType)0x01;
    }
...
Std_ReturnType EUSART_ASYNC_ReadStringNonBlocking(uint8 *_data, uint16 str_len) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    static uint16 char_counter = 0;


    while (char_counter < str_len && PIR1bits.RCIF) {
        _data[char_counter] = RCREG;
        char_counter++;
    }
...
Std_ReturnType EUSART_ASYNC_WriteStringNonBlocking(uint8 *_data, uint16 str_len) {
    ...
    while (TXSTAbits.TRMT && char_counter < str_len) {
        TXREG = _data[char_counter];
        char_counter++;
    }
