...
# 12 "MCAL/GPIO/../mcal_std_types.h" 2

# 1 "MCAL/GPIO/../compiler.h" 1
# 11 "MCAL/GPIO/../compiler.h"
...
# 11 "MCAL/GPIO/../compiler.h" 2
# 13 "MCAL/GPIO/../mcal_std_types.h" 2
...
# 56 "MCAL/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_get_direction_statues(const pin_config_t *_pin_config, direction_t *direction_statues){
    Std_ReturnType ret = (Std_ReturnType)0x01;

    if(((void*)0) == _pin_config || ((void*)0) == direction_statues || (_pin_config->pin > (8 - 1))){
        ret = (Std_ReturnType)0x00;
    }
     else{
       *direction_statues = ((*tris_registers[_pin_config->port] >> _pin_config->pin) & (uint8)1);
    }

    return ret;
}
# 78 "MCAL/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t logic){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((((void*)0) == _pin_config) || (_pin_config->pin > (8 - 1))){
        ret = (Std_ReturnType)0x00;
